...
#import "NGSDKEndCard.h"

#define kNGSDKAdTypeHTML 0
#define kNGSDKAdTypeVideo 1
#define kNGSDKAdTypeUnsupported 2
...
typedef enum {
    NGSDKDemoAppPlacementBanner = 0,
    NGSDKDemoAppPlacementMRect = 1,
    NGSDKDemoAppPlacementLeaderboard = 2,
    NGSDKDemoAppPlacementInterstitial = 3,
    NGSDKDemoAppPlacementRewarded = 4
} NGSDKMarkupPlacement;

typedef enum : NSUInteger {
    NGSDKStorekitAutomaticClickVideo = 1 << 0,
    NGSDKStorekitAutomaticClickDefaultEndCard = 1 << 1,
    NGSDKStorekitAutomaticClickCustomEndCard = 1 << 2
} NGSDKStorekitAutomaticClickType;

@class NGSDKCTAData;

@interface NGSDKAd : NSObject
...
@property (nonatomic, readonly) NSArray<NGSDKDataModel*> *beacons;
...
@property (nonatomic, strong) NGSDKCTAData* ctaData;
...
- (NGSDKDataModel *)assetDataWithType:(NSString *)type;
- (NGSDKOpenRTBDataModel *)openRTBAssetDataWithType:(NSString *)type;
- (NGSDKDataModel *)metaDataWithType:(NSString *)type;
- (NSArray *)beaconsDataWithType:(NSString *)type;
- (NGSDKSkAdNetworkModel *)getSkAdNetworkModel;
- (NGSDKSkAdNetworkModel *)getOpenRTBSkAdNetworkModel;
- (NGSDKSkAdNetworkModel *)getAdAttributionModel;
- (NGSDKSkAdNetworkModel *)getOpenRTBAdAttributionModel;
- (NGSDKContentInfoView *)getContentInfoView;
- (NGSDKContentInfoView *)getContentInfoViewFrom:(NGSDKContentInfoView *)infoView;
- (NGSDKContentInfoDisplay)determineContentInfoDisplay;
- (NGSDKContentInfoClickAction)determineContentInfoIconClickAction;
