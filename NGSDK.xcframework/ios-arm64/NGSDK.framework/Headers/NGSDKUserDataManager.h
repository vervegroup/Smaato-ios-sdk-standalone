...
@protocol NGSDKUserDataManagerDelegate <NSObject>
- (void)gppValuesDidChange;
@end

@interface NGSDKUserDataManager : NSObject

@property (nonatomic, readonly) BOOL isConsentPageLoaded;
@property (nonatomic) NSObject<NGSDKUserDataManagerDelegate> * _Nullable delegate;
