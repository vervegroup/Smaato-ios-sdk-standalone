...
typedef BOOL(^NGSDKStarRatingViewShouldBeginGestureRecognizerBlock)(UIGestureRecognizer *gestureRecognizer);

IB_DESIGNABLE
@interface NGSDKStarRatingView : UIControl
...
@property (nonatomic, copy) NGSDKStarRatingViewShouldBeginGestureRecognizerBlock shouldBeginGestureRecognizerBlock;
